...
export default class BscWallet implements Wallet20Interface<BscContract> {
    ...
    public async getBalanceToken(contract: BscContract): Promise<number> {
    ...
    public async createSendTokenTransaction(contract: BscContract, amount: number, toAddress: string) : Promise<TransactionInterface>
    {
    ...
    public async sendToken(contract: BscContract, amount: number, toAddress: string): Promise<string> {
    ...
    public async getContractEth(contract : BscContract) : Promise<Contract>
    {
